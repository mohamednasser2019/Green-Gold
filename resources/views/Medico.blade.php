                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="wow lightSpeedIn" data-wow-delay="0.1s">
                                        ...
                                        <p class="text-bold" style="text-align: center; font-size: 17px;" id="about">
                                ...
                                <div class="col-md-12">
                                    <div class="wow lightSpeedIn" data-wow-delay="0.1s">
                                        ...
                                        <div class="wow fadeInUp" data-wow-delay="0.2s" style="text-align: center;">
                                            ...
                                            <p style="text-align: center; font-size: 17px;">نحن نؤمن بالعمل الجماعي والعمل كفريق واحد حيث أنه لا يوجد حدود للطاقة
                                        ...
                                        <div class="wow fadeInUp" data-wow-delay="0.2s" style="text-align: center;">
                                            ...
                                            <p style="text-align: center; font-size: 17px;">نحن نحترم اتفاقاتنا ونحن صادقين في اتصالاتنا.</p>
                                        </div>
                                        <div class="wow fadeInUp" data-wow-delay="0.2s" style="text-align: center;">
                                            <h3 style="color:green;">الأداء</h3>
                                            <p style="text-align: center; font-size: 17px;">نحن نسعى جاهدين من أجل التحسين المستمر في أداء العمل لدينا، ونقوم بقياس
                                                النتائج بعناية فائقة،</p>
                                        </div>
                                        <div class="wow fadeInUp" data-wow-delay="0.2s" style="text-align: center;">
                                            <h3 style="color:green;">التركيز على العملاء</h3>
                                            <p style="text-align: center; font-size: 17px;">نحن نتجاوز توقعات العملاء للقيمة والخدمة. نحن نبني ونحافظ على علاقاتنا مع
                                                العملاء ونضمن رضا العملاء على المدى الطويل</p>
                                        </div>
                                        <div class="wow fadeInUp" data-wow-delay="0.2s" style="text-align: center;">
                                            <h3 style="color:green;">الابتكار</h3>
                                            <p style="text-align: center; font-size: 17px;">نحن نسعى دائما إلى إيجاد سبل مبتكرة من أجل تعزيز منتجاتنا وخدماتنا،
                                                وتقديم
                                        ...
                                        <div class="wow fadeInUp" data-wow-delay="0.2s" style="text-align: center;">
                                            ...
                                            <p style="text-align: center; font-size: 17px;">الجودة هي أمر راسخ ومتأصل في العمل من خلال زملائنا وجميع قيمنا. نمتلك شغف
                    ...
                    <div class="col-lg-12">
                        <div id="filters-container" class="cbp-l-filters-alignLeft">
                            ...
                            @foreach($data['Category'] as $cat)
                                @if($cat->id==5)
                                    <div data-filter=".{{$cat->id}}" class="cbp-filter-item-active cbp-filter-item">{{$cat->category_name}}
                                        (
