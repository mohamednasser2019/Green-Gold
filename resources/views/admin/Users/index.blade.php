...
<!-- DataTables Example -->
        ...
        <div class="card mb-3">
          <div class="card-header">
            	<i class="fas fa-table"></i> All Users Data
        	</div>
                  ...
                  <div class="panel-heading">
                    ...
                    <div class="panel-tools">                   
                      ...
                      <ul class="dropdown-menu dropdown-light pull-right" role="menu">
                        ...
                        <li>
                          <a class="panel-refresh" href="{{ URL::to('admin/users') }}"> <i class="fa fa-refresh"></i> <span>Refresh</span> </a>
                        </li>
                          ...
                          <div class="visible-xs visible-sm hidden-md hidden-lg">
                            <div class="btn-group">
                              ...
                              <ul role="menu" class="dropdown-menu pull-right dropdown-dark">
                                <li>
                                  <a role="menuitem" tabindex="-1" href="{{ URL::to('admin/users/'.$row->id.'/edit') }}">
                                    <i class="fa fa-edit">
                                ...
                                <li>
                                  <a role="menuitem" tabindex="-1" data-href="{{ URL::to('admin/users/'.$row->id.'/delete') }}" data-toggle="modal" data-target="#confirm-delete">
