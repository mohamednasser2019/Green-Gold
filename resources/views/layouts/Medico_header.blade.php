...
<head>
  ...
  <link href="{{ asset('public/css/medico/nivo-lightbox-theme/default/default.css')}}" rel="stylesheet" type="text/css" />
  ...
  <link href="{{ asset('public/css/medico/style.css')}}" rel="stylesheet">
